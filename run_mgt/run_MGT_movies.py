...
Run from project root: python run_mgt/run_MGT_movies.py --scoring f3|f4 --n_entities N --uniform_every_k K
"""
import argparse
import sys
...
# python run_mgt/run_MGT_movies.py --scoring f3 --n_entities 10000 --uniform_every_k 10000
# python run_mgt/run_MGT_movies.py --scoring f4 --n_entities 10000 --uniform_every_k 10000
